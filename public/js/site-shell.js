document.addEventListener('DOMContentLoaded', () => {
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-12 lg:gap-8">
          <div class="md:col-span-12 lg:col-span-4 flex flex-col gap-4">
            <a class="font-display text-xl font-bold text-white tracking-tight flex items-center gap-2" href="homepage.html">
              <img src="assets/images/logo.png" alt="VYBE Africa" class="h-8 w-auto object-contain" onerror="this.onerror=null;this.src='/LOGO.png'">
  ...
  // Dynamically load the image loader script if not already present
  if (!document.querySelector('script[src*="vybe-image-loader.js"]')) {
    const script = document.createElement('script');
    script.src = 'js/vybe-image-loader.js';
    script.async = true;
    document.body.appendChild(script);
  } else if (window.vybeRefreshImages) {
    window.vybeRefreshImages();
  }
});
